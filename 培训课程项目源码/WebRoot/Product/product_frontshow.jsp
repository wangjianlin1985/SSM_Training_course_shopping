...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Product/frontlist">课程信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课程id:</div>
		<div class="col-md-10 col-xs-6"><%=product.getProductId()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课程类别:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课程库存:</div>
		<div class="col-md-10 col-xs-6"><%=product.getProductNum()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课程价格:</div>
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6">
			<video src="<%=basePath%><%=product.getSksp()%>" poster="/templets/wzhan/images/1470963124.jpg" controls="" autoplay="autoplay" style="width:100%; height:auto;">
	 	</div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课程描述:</div>
