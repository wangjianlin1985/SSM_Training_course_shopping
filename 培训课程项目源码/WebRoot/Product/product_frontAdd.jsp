...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Product/frontlist">课程管理</a></li>
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="product_productClassObj_classId" class="col-md-2 text-right">课程类别:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="product_productName" class="col-md-2 text-right">课程名称:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_productName" name="product.productName" class="form-control" placeholder="请输入课程名称">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="product_mainPhoto" class="col-md-2 text-right">课程图片:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="product_productNum" class="col-md-2 text-right">课程库存:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_productNum" name="product.productNum" class="form-control" placeholder="请输入课程库存">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="product_price" class="col-md-2 text-right">课程价格:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_price" name="product.price" class="form-control" placeholder="请输入课程价格">
					 </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				  	 <label for="product_productDesc" class="col-md-2 text-right">课程描述:</label>
				  	 <div class="col-md-8">
...
<script>
//实例化编辑器
var product_productDesc_editor = UE.getEditor('product_productDesc'); //课程描述编辑器
