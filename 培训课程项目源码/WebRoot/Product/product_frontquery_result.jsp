...
<%
    ...
    String productName = (String)request.getAttribute("productName"); //课程名称查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Product/frontlist">课程信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Product/product_frontAdd.jsp" style="display:none;">添加课程</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<productList.size();i++) {
            		...
            		Product product = productList.get(i); //获取到课程对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Product/<%=product.getProductId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=product.getMainPhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		课程类别:<%=product.getProductClassObj().getClassName() %>
			     	</div>
			     	<div class="field">
	            		课程名称:<%=product.getProductName() %>
			     	</div>
			     	<div class="field">
	            		课程库存:<%=product.getProductNum() %>
			     	</div>
			     	<div class="field">
	            		课程价格:<%=product.getPrice() %>
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="productQueryForm" id="productQueryForm" action="<%=basePath %>Product/frontlist" class="mar_t15">
            ...
            <div class="form-group" style="display:none;">
            	<label for="productClassObj_classId">课程类别：</label>
			...
			<div class="form-group">
				<label for="productName">课程名称:</label>
				<input type="text" id="productName" name="productName" value="<%=productName %>" class="form-control" placeholder="请输入课程名称">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="product_productId_edit" class="col-md-3 text-right">课程id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="product_productId_edit" name="product.productId" class="form-control" placeholder="请输入课程id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="product_productClassObj_classId_edit" class="col-md-3 text-right">课程类别:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productName_edit" class="col-md-3 text-right">课程名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productName_edit" name="product.productName" class="form-control" placeholder="请输入课程名称">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_mainPhoto_edit" class="col-md-3 text-right">课程图片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productNum_edit" class="col-md-3 text-right">课程库存:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productNum_edit" name="product.productNum" class="form-control" placeholder="请输入课程库存">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_price_edit" class="col-md-3 text-right">课程价格:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_price_edit" name="product.price" class="form-control" placeholder="请输入课程价格">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="product_productDesc_edit" class="col-md-3 text-right">课程描述:</label>
		  	 <div class="col-md-9">
...
<script>
//实例化编辑器
var product_productDesc_edit = UE.getEditor('product_productDesc_edit'); //课程描述编辑器
