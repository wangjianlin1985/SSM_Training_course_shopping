...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">IT培训网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=1">Java课程</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=2">Android课程</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=3">PHP课程</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=4">ASP.NET课程</a></li> 
